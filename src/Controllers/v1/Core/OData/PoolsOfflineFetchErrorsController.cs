...
{
    [Route("api/core/odata/poolsofflinefetcherrors")]
    [Authorize(Policy = "core-read")]
    [Produces("application/json")]
    // [ApiExplorerSettings(GroupName = "OData/PoolsOfflineFetchErrors")]
    public class PoolsOfflineFetchErrorsController : ODataController
    {
