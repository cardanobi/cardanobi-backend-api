...
{
    [Table("param_proposal")]
    [Index("cost_model_id", Name = "idx_param_proposal_cost_model_id")]
    [Index("registered_tx_id", Name = "idx_param_proposal_registered_tx_id")]
    public partial class ParamProposal
    {
        ...
        [Precision(20, 0)]
        public decimal? max_epoch { get; set; }

        /// <summary>The optimal number of stake pools.</summary>
        [Precision(20, 0)]
        public decimal? optimal_pool_count { get; set; }
        ...
        /// <summary>The CostModel table index for the proposal.</summary>
        ...
        /// <summary>The Tx table index for the transaction that contains this parameter proposal.</summary>
        public long registered_tx_id { get; set; }

        /// <summary>For Alonzo this is the cost per UTxO word. For Babbage and later per UTxO byte. New in v13: Renamed from coins_per_utxo_word.</summary>
        [Precision(20, 0)]
        public decimal? coins_per_utxo_size { get; set; }

        // Derived fields
        /// <summary>The hexadecimal encoding of the hash of the crypto key used to sign this proposal.</summary>
        public string key_hex { get { return Convert.ToHexString(key).ToLower(); } set { } }
    }
}
